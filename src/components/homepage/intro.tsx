                ...
                <div className="grid gap-14 lg:grid-cols-2">
                    ...
                    <div className="wow fadeInUp" data-wow-delay='.6s'>
                        <div className="mx-auto max-w-[645px]">
                            <div className="wow fadeInUp mb-2.5 text-left bg-clip-text text-sm lg:text-base font-bold text-transparent bg-linear-(--gradient2) uppercase" data-wow-delay='.3s'>
                                O aplikacji
                            </div>
                            <h2 className="text-foreground wow fadeInUp mb-12 text-left text-xl font-extrabold lg:text-4xl" data-wow-delay='.6s'>
                        ...
                        <div className="my-10 space-y-4">
                            <div className="flex ml-1.5 items-center gap-2">
                                <img src="/icons/sign-icon.png" alt="" width={20} height={20} />
